...
const corsOptions = {
  origin: [ // allowed origins for CORS
    'https://auth.flag.lsuthar.in',
    'https://feature.flag.lsuthar.in',
    'https://gateway.flag.lsuthar.in',
  ],
...
app.use('/admin', express.json(), adminJwt, publicRoutesRouter)

app.use(
  (req, res, next) => {

    if (publicRoutesCache.isPublicRoute(req.path)) {
      return next();
    }
